...
export function features(pubkey) {
  ...
  return [
    // 11. Bronze Altar — stateful feature with clue reveal and hidden portal
    {
      ...
      content: 'A squat bronze altar, green with verdigris. Strange symbols are etched into its surface.',
    },
    ...
    // 12. Crumbling Inscription — examine surfaces puzzle
    {
      ...
      content: 'Faded letters carved deep into stone. Most have been worn away by time.',
    },
    ...
    // 13. Weathered Journal — examine surfaces tutorial clue
    {
      ...
      content: 'A leather-bound journal, warped by rain. A few pages are still legible.',
    },
    ...
    // Standing Stone — stateful, examine reveals clue
    {
      ...
      content: 'A tall stone, rough-hewn and ancient, stands at the edge of the clearing. Lichen covers most of its surface, but you can make out faint carved letters beneath.',
    },
    ...
    // Stained Glass Window — examine reveals clue about serpent and staff
    {
      ...
      content: 'Fragments of coloured glass still cling to the chapel window frame. The surviving panels depict a serpent coiled around a staff, held aloft before something vast and dark.',
    },
    ...
    // Locked Chest — requires iron key to interact
    {
      ...
      content: 'A heavy wooden chest, bound with iron bands. You turn the iron key and the lock clicks open. Inside, a serpent amulet rests on faded cloth.',
    },
    ...
    // Cave Paintings — examine reveals clue about lake history
    {
      ...
      content: 'Faded ochre figures dance across the cave wall. They depict people gathered around a body of water, arms raised. Something vast coils beneath the surface.',
    },
    ...
    // 14. Iron Gate — locked, requires chapel-solved
    {
      ...
      content: 'A heavy iron gate, cold to the touch. There is no visible lock.',
    },
    ...
    // Wall Carvings — in chapel crypt, reveals clue
    {
      ...
      content: 'Intricate carvings cover the crypt walls. They depict a serpent coiled around a staff, descending into water. Beneath the images, text is carved in a steady hand.',
    },
    ...
    // Stone Sarcophagus — in chapel crypt, contains serpent amulet
    {
      ...
      content: 'A stone sarcophagus rests on a raised dais. The lid is carved with a serpent motif. It looks sealed but not locked — just very heavy.',
    },
    ...
    // Items set-state externally: amulet → amulet-placed, staff → activated
    {
      ...
      content: 'A complex device of dark stone and orichalcum channels, set into the north wall. Two recesses are carved into its face — one round, one long and narrow. The orichalcum channels trace intricate patterns across the wall and floor, all converging on this point.',
    },
  ];
}
