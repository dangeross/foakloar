  ...
  return [
    ...
    // Brass Lantern — stateful item with battery counter
    {
      ...
      tags: [
        ...
        ['on-counter', 'down', 'battery', '0', 'consequence', a(`${T}:consequence:darkness`)],
        ['on-interact', 'turn on', 'set-state', 'on'],
        ['on-interact', 'turn off', 'set-state', 'off'],
        ['sound', a(`${T}:sound:lantern-hum`), 'layer', '0.4', 'on'],
        ['sound', a(`${T}:sound:lantern-crackle`), 'layer', '0.3', 'on'],
        ['sound', a(`${T}:sound:lantern-hum`), 'layer', '0.3', 'flickering'],
        ['sound', a(`${T}:sound:lantern-crackle`), 'layer', '0.2', 'flickering'],
      ],
      content: 'A sturdy brass lantern, dented but functional. A small dial on the side reads the battery level.',
    },
    ...
    // Serpent Amulet — given by sarcophagus in chapel crypt
    {
      ...
      content: 'An amulet of orichalcum, shaped like a coiled serpent. It is warm to the touch, as if alive.',
    },
    ...
    // Serpent Staff — given by sarcophagus in chapel crypt
    {
      ...
      content: 'A staff of dark wood, carved with serpent scales. The head is shaped like a coiled serpent, matching the amulet.',
    },
  ];
}
