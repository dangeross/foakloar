  ...
  return [
    ...
    // Deposits stolen items at the Flooded Passage stash.
    {
      ...
      tags: [
        ...
        ['description', 'A tall, gaunt figure draped in shadow. It moves without sound, its long fingers curling and uncurling. It does not acknowledge you — it is interested only in what you carry.'],
      ],
      content: '',
    },
  ];
