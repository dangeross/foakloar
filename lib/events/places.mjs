  ...
  return [
    // 1. Sunlit Clearing — genesis place
    {
      ...
      tags: [
        ...
        ['sound', a(`${T}:sound:forest-ambient`), 'ambient', '0.5'],
      ],
      content:
    ...
    // 2. Dark Cave
    {
      ...
      tags: [
        ...
        ['sound', a(`${T}:sound:cave-drone`), 'ambient', '0.6'],
        ['sound', a(`${T}:sound:water-drip`), 'layer', '0.3'],
      ],
      content:
    ...
    // 3. Ruined Chapel
    {
      ...
      tags: [
        ...
        ['sound', a(`${T}:sound:chapel-ambient`), 'ambient', '0.5'],
      ],
      content:
    ...
    // Cave Network — below dark cave, requires lantern
    {
      ...
      tags: [
        ...
        ['npc', a(`${T}:npc:collector`)],
        ['sound', a(`${T}:sound:deep-drone`), 'ambient', '0.7'],
        ['sound', a(`${T}:sound:water-echo`), 'layer', '0.4'],
      ],
      content:
    ...
    // 4. Underground Lake — markdown content
    {
      ...
      tags: [
        ...
        ['sound', a(`${T}:sound:lake-ambient`), 'ambient', '0.8'],
      ],
      content:
