...
import { buildStrudelCodeFromTags, decompileStrudelCode } from '../../services/sound-builder.js';
import { previewSound, stopPreview, playOneShotFromTags } from '../../services/sound.js';
...
export default function EventEditor({
  ...
  const hasTitle = ['place', 'item', 'feature', 'clue', 'npc', 'payment', 'world', 'quest', 'portal', 'puzzle', 'recipe', 'consequence', 'sound'].includes(eventType);
